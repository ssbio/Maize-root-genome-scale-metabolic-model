...
objective..		Z =e= sum(j, v(j));

*objective..		Z =e= v('R00200[R,c,GS1]');

mass_balance(i)..	sum(j, S(i,j) * v(j)) =e= 0;

biomass_enforcement..	v('Root_Biomass[GS1]') =e= 1632.488024;
